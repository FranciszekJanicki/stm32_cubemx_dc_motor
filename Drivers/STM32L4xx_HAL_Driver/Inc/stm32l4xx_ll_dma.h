...
__STATIC_INLINE void LL_DMA_EnableChannel(DMA_TypeDef* DMAx, uint32_t Channel)
{
    ...
    SET_BIT(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR, DMA_CCR_EN);
}
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    CLEAR_BIT(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR, DMA_CCR_EN);
}
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    return ((READ_BIT(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR,
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    MODIFY_REG(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR,
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    MODIFY_REG(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CNDTR,
               DMA_CNDTR_NDT,
               NbData);
}
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    return (READ_BIT(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CNDTR,
                     DMA_CNDTR_NDT));
}
                                            ...
                                            uint32_t Direction)
{
    ...
    if (Direction == LL_DMA_DIRECTION_MEMORY_TO_PERIPH) {
        WRITE_REG(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CMAR,
                  SrcAddress);
        WRITE_REG(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CPAR,
                  DstAddress);
    }
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    return (READ_REG(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CMAR));
}
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    return (READ_REG(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CPAR));
}
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    SET_BIT(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR, DMA_CCR_TCIE);
}
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    SET_BIT(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR, DMA_CCR_HTIE);
}
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    SET_BIT(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR, DMA_CCR_TEIE);
}
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    CLEAR_BIT(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR, DMA_CCR_TCIE);
}
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    CLEAR_BIT(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR, DMA_CCR_HTIE);
}
...
{
    uint32_t dma_base_addr = (uint32_t)DMAx;
    CLEAR_BIT(((DMA_channelDef*)(dma_base_addr + CHANNEL_OFFSET_TAB[Channel]))->CCR, DMA_CCR_TEIE);
}
