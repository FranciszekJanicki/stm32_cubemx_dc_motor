...
static uint32_t DFSDM_GetChannelFromInstance(const DFSDM_channelDef* Instance);
...
HAL_DFSDM_Channel_StateTypeDef HAL_DFSDM_ChannelGetState(
    const DFSDM_Channel_HandleTypeDef* hdfsdm_channel)
{
...
HAL_DFSDM_Filter_StateTypeDef HAL_DFSDM_FilterGetState(
    const DFSDM_Filter_HandleTypeDef* hdfsdm_filter)
{
